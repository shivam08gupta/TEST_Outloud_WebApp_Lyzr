...
export const handleApiError = (
  ...
  // Check for API error — an agent-level failure (200 + success:false), not
  // broken app code, so it is returned for the caller's own UI without
  // auto-escalating to the parent. Genuine server/upstream failures reach the
  // parent via fetchWrapper's 5xx handling.
